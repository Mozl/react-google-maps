...
var OverlayView = (exports.OverlayView = (function(_React$PureComponent) {
  ...
  function OverlayView(props, context) {
    ...
    overlayView.onAdd = _this.onAdd.bind(_this)
    overlayView.draw = _this.draw.bind(_this)
    overlayView.onRemove = _this.onRemove.bind(_this)
    _this.onPositionElement = _this.onPositionElement.bind(_this)
  ...
  ;(0, _createClass3.default)(OverlayView, [
    ...
    },
    {
      ...
      value: function componentDidUpdate(prevProps) {
        ...
        setTimeout(this.state[_constants.OVERLAY_VIEW].draw)
      },
    },
    {
